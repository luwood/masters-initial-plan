...
Um dos aspectos criticos para a desempenho de qualquer implementação de \textit{TOB} é o tratamento de concorrência. \textit{TOBs} precisam lidar com diversos eventos concorrentes: recepção/transmissão de mensagens, eventos de controle e persistência de dados. 
